...
exports.build = gulp.series('clean', images, spriteMono, spriteMulti, fonts, scripts, html, css_build);

exports.default = gulp.series('clean', images, spriteMono, spriteMulti, fonts, scripts, html, css, watch);